...
export const AgentPlanId = makeEntityId("AgentPlanId");
export type AgentPlanId = typeof AgentPlanId.Type;
export const AgentTaskId = makeEntityId("AgentTaskId");
export type AgentTaskId = typeof AgentTaskId.Type;
export const AgentSharedUpdateId = makeEntityId("AgentSharedUpdateId");
export type AgentSharedUpdateId = typeof AgentSharedUpdateId.Type;
export const AgentContractId = makeEntityId("AgentContractId");
export type AgentContractId = typeof AgentContractId.Type;
export const AgentCoordinationMessageId = makeEntityId("AgentCoordinationMessageId");
export type AgentCoordinationMessageId = typeof AgentCoordinationMessageId.Type;
export const AgentReviewId = makeEntityId("AgentReviewId");
export type AgentReviewId = typeof AgentReviewId.Type;
