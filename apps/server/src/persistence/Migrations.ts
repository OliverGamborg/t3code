...
import Migration0033 from "./Migrations/033_AgentPlans.ts";
import Migration0034 from "./Migrations/034_AgentCoordination.ts";
import Migration0035 from "./Migrations/035_ThreadAgentMetadataAndAgentPlanCleanup.ts";
...
export const migrationEntries = [
  ...
  [33, "AgentPlans", Migration0033],
  [34, "AgentCoordination", Migration0034],
  [35, "ThreadAgentMetadataAndAgentPlanCleanup", Migration0035],
] as const;
